...
export const SuccessModal: React.FC<SuccessModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-xs">
      <div className="bg-white w-full max-w-md rounded-2xl p-6 shadow-2xl border border-slate-200 text-center animate-in fade-in zoom-in duration-200">
        ...
        {/* Summary Card */}
        <div className="mt-4 p-3.5 bg-slate-50 rounded-xl border border-slate-200 text-left flex items-center gap-3">
          <div className="w-14 h-16 rounded-lg overflow-hidden border border-slate-300 bg-slate-200 flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-400 font-medium">{marshal.region}</span>
            </div>
            ...
            <div className="mt-1 pt-1 border-t border-slate-200 text-[11px] text-slate-600 flex items-center justify-between">
        ...
        {/* Sync Status Note */}
        <div className="mt-3 p-2.5 rounded-lg text-xs flex items-center gap-2 text-left bg-blue-50 border border-blue-200 text-blue-900">
          {isOffline ? (
            <>
        ...
        <div className="mt-5 grid grid-cols-2 gap-2.5">
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl border border-slate-300 bg-white hover:bg-slate-50 text-slate-700 text-xs font-bold transition"
          >
