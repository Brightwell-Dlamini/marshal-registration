...
export type AdminTab = 'dashboard' | 'directory';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="inline-block px-2 py-0.5 rounded text-[10px] font-bold bg-blue-500/20 text-blue-300 border border-blue-500/30">
                  STAFF ONLY
                </span>
              </div>
              <p className="text-[11px] sm:text-xs text-slate-300 font-medium flex items-center gap-2">
                <span>Dashboard &amp; Marshal Registry</span>
                <span
