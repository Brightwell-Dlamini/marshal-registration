...
export const RegistrationForm: React.FC<RegistrationFormProps> = ({ onSuccess }) => {
  ...
  // Auto-fill using the exact details from the uploaded form!
  const handlePrefillSample = () => {
    ...
    // Attach sample signature if empty
    if (!signatureDataUrl) {
      setSignatureDataUrl(
        'data:image/svg+xml;utf8,' +
          encodeURIComponent(`
  ...
  const validate = (): boolean => {
    ...
    // Marital profiling validation: partner name required if married or cohabiting
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-slate-200/90 overflow-hidden">
        ...
        <div className="bg-slate-900 text-white p-5 sm:p-7 border-b-4 border-amber-500 text-center relative">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-4 border-b border-slate-800">
            {/* Minibus emblem & Association Title */}
          ...
          {/* Official Manzini Address & Contact */}
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-8 space-y-6 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start pb-6 border-b border-slate-200">
            {/* Profile Photo (Passport size upload / camera) */}
          ...
          <div className="space-y-5 pb-6 border-b border-slate-200">
            ...
            <div className="bg-rose-50/40 border border-rose-100 rounded-2xl p-4 sm:p-5 space-y-5">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          {isSelected && <CheckCircle2 className="w-3.5 h-3.5 text-rose-400 flex-shrink-0" />}
                        </div>
                        <span className={`text-[10px] mt-1 block line-clamp-1 ${isSelected ? 'text-rose-200' : 'text-slate-400'}`}>
                          {opt.desc}
                        </span>
                      </button>
                    );
              ...
              {/* Partner / Spouse Name & Number of Kids */}
                ...
                <div className="md:col-span-7">
                  <label className="block text-xs font-bold uppercase tracking-wider text-slate-800 mb-1">
                    ...
                    maritalStatus === 'Cohabiting' ? (
                      ...
                      <span className="text-slate-400 font-normal lowercase">(optional for {maritalStatus})</span>
                    )}
                  </label>
                  <div className="relative">
                  ...
                  <span className="text-[10px] text-slate-500 mt-1 block">
                    Full name of husband, wife, or customary partner.
                  </span>
                  {errors.partnerName && (
          ...
          {/* Section 3: Civic & Traditional Authority Identifiers */}
          <div className="space-y-4 pb-6 border-b border-slate-200">
            <h3 className="text-xs font-black uppercase tracking-wider text-slate-500 flex items-center gap-1.5">
          ...
          {/* Section 5: Agreement & Member's Signature */}
          <div className="space-y-5 pb-6 border-b border-slate-200">
            {/* Agreement Box */}
        ...
        {/* Footer: Official Regional Branches reference */}
