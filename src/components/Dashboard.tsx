        ...
        <div className="space-y-2.5">
          {stats.byRegion.map((r) => (
            <div key={r.region} className="flex items-center gap-3">
              <span className="w-24 text-xs font-bold text-slate-700 flex-shrink-0">
                {r.region}
              </span>
              <div className="flex-1 h-6 bg-slate-100 rounded-lg overflow-hidden relative">
                ...
                />
                <span className="absolute inset-0 flex items-center justify-end pr-2 text-[11px] font-bold text-slate-700">
                  {r.count}
                </span>
              </div>
            </div>
